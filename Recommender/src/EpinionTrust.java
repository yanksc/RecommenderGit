...
public class EpinionTrust implements Comparable{

	User fromU, toU;
	BigInteger timeStamp;
	double cor=0;
	HashSet<TagAction> InfRecord;
	public EpinionTrust(User u, User v, BigInteger ts){
		fromU = u;
		toU = v;
		timeStamp = ts;
		InfRecord = new HashSet<TagAction>();
	}
	public EpinionTrust(User u, User v){
		fromU = u;
		toU = v;
	}
...
//	}
	@Override
	public int compareTo(Object obj) {
		EpinionTrust r = (EpinionTrust) obj;
